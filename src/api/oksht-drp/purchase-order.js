...
// 新增提交
export const savePurchaseOrder = async (url, data) =>
  new Promise((resolve) => {
    request({
      url,
      method: 'post',
...
// 改变订单状态
export const dispatchPurchaseDoWaste = async (data) =>
  new Promise((resolve) => {
    request({
...
// 更改审批状态
export const dispatchPurchaseExamineOrder = (data) =>
  new Promise((resolve) => {
    request({
...
// 取消采购数量
export const dispatchCancelPurchase = (data) =>
  new Promise((resolve) => {
    request({
...
// 关联采购申请单
export const dispatchRelatedPurchase = (data) =>
  new Promise((resolve) => {
    request({
...
// 解除锁定数量
export const dispatchUnlockPurchase = (data) =>
  new Promise((resolve) => {
    request({
...
// 采购控货锁定
export const dispatchControlUnlock = (data) =>
  new Promise((resolve) => {
    request({
...
// 商品整包提示
export const checkIsWholePackage = (data) =>
  new Promise((resolve) => {
    request({
