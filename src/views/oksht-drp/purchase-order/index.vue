...
<template>
  <basicContainer>
    ...
    <el-table height="700" v-loading="loading" border size="mini" :data="tableData" style="width: 100%"
      ...
      <el-table-column prop="supplierContractNo" label="供应商合同号" width="160" align="center" show-overflow-tooltip />
